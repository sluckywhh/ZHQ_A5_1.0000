...
INT32 CJSKMakeInvoice::GPXXCX_Proc(CInvVol *pInvVol, string &strErr)
{
...
void CJSKMakeInvoice::AddInvDetail2Data(CInvHead *pInvHead,UINT8 *pDataPtr,UINT32 &nDataLen)
{
	INT8 tmpBuf[128];
