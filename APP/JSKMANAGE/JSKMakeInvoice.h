...
public:
	...
	*/
	static INT32 GPXXCX_Proc(CInvVol *pInvVol, string &strErr);
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 FPKJ_Proc(CInvHead *pInvhead, string &strErr, UINT8 wasteflag=0);
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 FPZF_Proc(CInvHead *pInvhead, UINT8 zflx, string &strErr);
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 FPCX_Proc(UINT8 cxfs, string cxtj, UINT32 &invNum, CInvHead *pInvhead, string &strErr);
	...
	*/
	...
	@return 
	*/
	static void AddInvDetail2Data(CInvHead *pInvHead,UINT8 *pDataPtr,UINT32 &nDataLen);
	static void Str2InvHead(INT8 *pDataPtr,CInvHead *pInvHead);
...
private:
	...
	@return 
	*/
	static INT32 MakeInvAuthority(CInvHead *pInvHead, string& strErr);
