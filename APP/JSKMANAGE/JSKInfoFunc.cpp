...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::GetCorpInfo(CUserInfo *pUserInfo,CTax *pTax,string &strErr)
{
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::GetFirstOffInvInfo(CInvHead *pInvHead,string &strErr)
{
...
INT32 CJSKInfoFunc::GetOffLimitInfo(UINT8 fplx, CInvKind *invKind,string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	DBG_ENTER("GetOffLimitInfo");
	//DBG_ASSERT_EXIT(pInvVol != NULL), (" pInvVol == NULL "));
...
//返回值：
//---------------------------------------------------------
INT32 CJSKInfoFunc::App2NetInvVol(UINT8 Type,UINT16 &outLen,UINT8 *NetCrypData,CInvVol *pInvVol,string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	UINT16 nOutLen=0;
	UINT8 *pJSKSendBuf =NULL;
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::GetJSKInvVolInfo(CInvVol *invVol, UINT32 &nInvNum, string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	INT8 tmpBuf[64];
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::GetCurInvInfo(CInvVol *pInvVol,string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	DBG_ENTER("GetCurInvInfo");
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::MakeInvHandInfo(CInvHead *pInvHead, string &strErr)
{
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::WasteInvHandInfo(CInvHead *pInvHead,string &strErr)
{
	...
	// CInvHead 到 TaxCardInvCancel 转换
	//pTaxCardInvHead 组装发票信息buf
	INT8 tmpBuf[JSK_MAKE_INV_SIGN_LEN];
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::HostToInvBSP(CInvVol *pInvVol, string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	UINT16 nOutLen=0;
	UINT8 *pJSKSendBuf =NULL;
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::HostToInvJSP(CInvVol *pInvVol, string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	UINT16 nOutLen=0;
	UINT8 *pJSKSendBuf =NULL;
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::InvVolRetBSP(CInvVol *pInvVol, string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	UINT16 nOutLen=0;
	UINT8 *pJSKSendBuf =NULL;
...
//返回值：
//----------------------------------------------------------
INT32 CJSKInfoFunc::InvVolRetJSP(CInvVol *pInvVol, string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	UINT16 nOutLen=0;
	UINT8 *pJSKSendBuf =NULL;
...
INT32 CJSKInfoFunc::GetInvDetailInfoNO(CInvHead *pInvHead,string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	UINT16 nOutLen=0;
	UINT8 *pJSKSendBuf =NULL;
...
INT32 CJSKInfoFunc::GetInvDetailInfoNO(CInvHead *pInvHead, UINT8 *invBuff, UINT32 &invLen, string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	UINT16 nOutLen=0;
	UINT8 *pJSKSendBuf =NULL;
...
INT32 CJSKInfoFunc::GetInvDetailInfoDate(UINT8 *chDate,CInvHead *pInvHead,UINT8 &uInvFlag,string &strErr)
{
	INT32 ret=JSK_SUCCESS;
	UINT16 nOutLen=0;
	UINT8 *pJSKSendBuf =NULL;
...
INT32 CJSKInfoFunc::GetMonthCountDate(UINT32 iDate,UINT8 FpType,CTjxxhz *pTjxxhz,string &strErr)
{
