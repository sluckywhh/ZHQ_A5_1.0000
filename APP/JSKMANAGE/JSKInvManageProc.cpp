...
INT32 CJSKInvManageProc::BSPFPCX_Proc(string fplxdm, UINT32 &invNum, CInvVol *pInvVol, string &strErr)
{
	INT32 retcode = 0;
	INT8 tmpbuf[64];
	UINT8 fplx;
...
INT32 CJSKInvManageProc::BSPFPFF_Proc(UINT8 jzlx, CInvVol *pInvVol, string &strErr)
{
	INT32 retcode = 0;
	INT8 tmpbuf[64];
...
INT32 CJSKInvManageProc::BSPFPSH_Proc(UINT8 jzlx, CInvVol *pInvVol, string &strErr)
{
	INT32 retcode = 0;
	INT8 tmpbuf[64];
...
INT32 CJSKInvManageProc::TJXXCX_Proc(string strFplxdm, INT32 &MonthCount, CTjxxhz *pTjxxhz, string &strErr)
{
	INT32 retcode = 0;
	INT8 tmpbuf[64];
	UINT8 fplx = 0;
