...
//	virtual INT32 BSPBH_Business(CYWXML_GY &ywxml_gy, string &bspbh, string &strErr)=0;
	...
	//税控设备信息查询
	virtual INT32 SKPXXCX_Business(CYWXML_GY &ywxml_gy, CUserInfo *pUserInfo, string &strCurTime, string &strErr)=0;

	//税控设备其他信息查询
	virtual INT32 SKSBQTYXXCX_Business(CYWXML_GY &ywxml_gy, UINT8 xxlx, string &sksbxx, string &strErr)=0;

	//报税盘信息查询
	virtual INT32 BSPXXCX_Business(CYWXML_GY &ywxml_gy, CUserInfo *pUserInfo, string &strErr)=0;

	//监控数据查询
	virtual INT32 JKSJCX_Business(CYWXML_GY &ywxml_gy, CInvKind *pInvKind, string &strErr)=0;

	//授权税率查询
	virtual INT32 SQSLCX_Business(CYWXML_GY &ywxml_gy, CTax *pTax, UINT8 &taxNum, string &strErr)=0;

	//购票信息查询
	virtual INT32 GPXXCX_Business(CYWXML_GY &ywxml_gy, CInvVol *pInvVol, string &strErr)=0;
	...
	//发票开具
	virtual INT32 FPKJ_Business(CYWXML_GY &ywxml_gy, CInvHead *pInvhead, string &strErr)=0;
	
	//发票作废
	virtual INT32 FPZF_Business(CYWXML_GY &ywxml_gy, CInvHead *pInvhead, UINT8 zflx, string &strErr)=0;

	//发票查询
	virtual INT32 FPCX_Business(CYWXML_GY &ywxml_gy, UINT8 cxfs, string cxtj, UINT32 &invNum, CInvHead *pInvhead, string &strErr)=0;

	//税控设备报税盘组合操作
	virtual INT32 SKPBSP_Business(CYWXML_GY &ywxml_gy, UINT8 czlx, string &strErr)=0;

	//发票段信息查询(报税盘发票查询)
	virtual INT32 BSPFPCX_Business(CYWXML_GY &ywxml_gy, UINT32 &invNum, CInvVol *pInvVol, string &strErr)=0;

	//发票分发
	virtual INT32 BSPFPFF_Business(CYWXML_GY &ywxml_gy, UINT8 jzlx, CInvVol *pInvVol, string &strErr)=0;

	//发票收回
	virtual INT32 BSPFPSH_Business(CYWXML_GY &ywxml_gy, UINT8 jzlx, CInvVol *pInvVol, string &strErr)=0;
	...
	//发票统计信息查询
	virtual INT32 TJXXCX_Business(CYWXML_GY &ywxml_gy, INT32 &monthcount, CTjxxhz *pTjxxhz, string &strErr)=0;
